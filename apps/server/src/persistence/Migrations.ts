...
import Migration0042 from "./Migrations/041_AuthSessionClientInstanceId.ts";
import Migration0043 from "./Migrations/042_ProjectionTasks.ts";
import Migration0044 from "./Migrations/044_CleanOscPollution.ts";
...
export const migrationEntries = [
  ...
  [42, "AuthSessionClientInstanceId", Migration0042],
  [43, "ProjectionTasks", Migration0043],
  [44, "CleanOscPollution", Migration0044],
] as const;

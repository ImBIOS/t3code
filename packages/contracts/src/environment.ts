...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands task.schedule / task.cancel commands and runs the
      server-side scheduler that fires due tasks. Same version-skew contract
      as threadSettlement. */
  taskScheduling: Schema.optionalKey(Schema.Boolean),
